...
index_weight_wenjian = [8.82, 0.00, 7.59, 7.67, 28.27, 7.26, 26.38]
index_weight_pingheng = [10.00, 3.32, 11.40, 11.76, 18.95, 10.62, 15.00]
index_weight_jinqu = [12.00, 9.97, 13.55, 18.85, 14.96, 10.72, 5.00]
#index_weight_wenjian = [0.54, 2.50, 9.05, 7.50, 46.88, 7.43, 26.11]
#index_weight_pingheng = [0.47, 3.93, 11.37, 11.35, 36.50, 11.81, 24.57]
#index_weight_jinqu = [0.41, 5.12, 13.36, 14.56, 24.02, 16.80, 25.73]
pre_end_date = "2017-07-31"
